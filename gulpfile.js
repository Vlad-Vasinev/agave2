...
const images = () => {
  return src([`${paths.srcImgFolder}/**/**.{jpg,jpeg,png,svg,mp4,webm,webp}`])
...
const api = () => {
  return src([`${paths.apiFolder}/**/**.{json}`])
    .pipe(dest(paths.buildApiFolder))
};
...
exports.backend = series(clean, pugHtml, scriptsBackend, stylesBackend, resources, images, svgSprites, Sprites)

// exports.build = series(toProd, clean, htmlInclude, scripts, styles, resources, images, webpImages, svgSprites, htmlMinify);
exports.build = series(toProd, clean, pugHtml, scripts, styles, resources, images, svgSprites, Sprites);
